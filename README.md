...
## 🎓 Academic Highlights
* Upcoming: Admission in the VU PhD program with the Massivizing Computer Systems group, researching Digital Twins of ICT infrastructure, under the National 6G Future Network Services NL Groeifonds (expected 2026-2030).
* Pursuing an MSc in Computer Science (VU-UvA joint degree) focusing on large-scale distributed systems (currently: Cum Laude, 9.6 GPA).
* BSc in Computer Science, with Cum laude, Honours distinctions, and with a 9.1 GPA, from VU Amsterdam.
* The Student Talent Award 2025 awarded by the Faculty of Science, VU Amsterdam.
